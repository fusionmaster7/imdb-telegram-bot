...
url = "https://www.imdb.com/find?q=american+pie&ref_=nv_sr_sm"
response = get(url)
...
movieInfo = {'title': '', 'rating': '', 'duration': '', 'category':'', 'summary': '', 'directors': [], 'writers': [], 'stars': [], 'casts': [], 'storyline': '', 'genres': []}
##### For Scraping Title ######
...
category = html_soup.find('div', class_='subtext').a.text
...
storyline = html_soup.find('div', class_='inline canwrap').p.span.text.strip()
